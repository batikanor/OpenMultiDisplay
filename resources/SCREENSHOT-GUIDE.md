# Screenshot Capture Guide — OpenMultiDisplay
...
| | |
|---|---|
| **File** | `resources/logo/openmultidisplay-icon.png` |
| **Size** | 128 x 128 px |
| **Format** | PNG (transparent background preferred) |

**What to capture:**
- The OpenMultiDisplay app icon at 128x128 resolution
...
4. Save to `resources/logo/openmultidisplay-icon.png`
...
**What to capture:**
- Your Mac screen with the OpenMultiDisplay menu bar app running
...
1. Connect your tablet and start OpenMultiDisplay on both devices
...
- The virtual display created by OpenMultiDisplay should be visible alongside your main display
...
2. Ensure OpenMultiDisplay is running and the virtual display is visible in the arrangement
...
**What to capture:**
- The OpenMultiDisplay macOS settings window (frosted glass / vibrancy UI)
- All settings should be visible: resolution, frame rate, bitrate, quality, gaming mode toggle

**How to capture:**
1. Click the OpenMultiDisplay menu bar icon to open settings
...
**How to capture:**
1. Open the OpenMultiDisplay app on Android
