...
class VirtualDisplayManager {
    ...
    func saveDisplayPosition() {
        ...
        defaults.set(Int(position.x), forKey: "OpenMultiDisplay_positionX")
        defaults.set(Int(position.y), forKey: "OpenMultiDisplay_positionY")
        defaults.set(true, forKey: "OpenMultiDisplay_hasPosition")
    ...
    func restoreDisplayPosition() -> Bool {
        ...
        let y = defaults.integer(forKey: "OpenMultiDisplay_positionY")
